<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.professor_name" placeholder="请输入专家名称" style="width:200px" class="filter-item" />
      <el-input v-model="listQuery.professor_title" placeholder="职称" style="width:200px" class="filter-item" />
